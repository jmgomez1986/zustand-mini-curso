...
export const WeddingInvitationPage = () => {
  ...
  const eventYYYYMMDD = useWeddingBoundStore((state) => state.eventYYYYMMDD()); // Como es una funcion y necesito el string, se llama con (
  ...
  const setIsConfirmed = useWeddingBoundStore((state) => state.setConfirmation);
